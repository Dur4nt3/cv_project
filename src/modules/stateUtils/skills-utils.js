...
export function updateSkills(event, itemId, property, state, stateUpdater) {
...
export function addSkillsItem(state, stateUpdater) {
...
export function removeSkillsItem(state, stateUpdater) {
    const idList = Object.keys(state);
    if (idList.length === 1) {
        return;
    }
